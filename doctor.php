...
<head>
  ...
  <title>Dashboard - Evercare</title>
...
<body class="bg-gray-100 min-h-screen flex">
  ...
  <aside class="w-64 bg-primary text-white min-h-screen p-6 space-y-6 hidden md:block">
    ...
    <nav class="space-y-4">
      <a href="dashboard.php" class="flex items-center space-x-3 bg-white/20 p-2 rounded">
        <i class="ri-dashboard-line ri-lg"></i><span>Dashboard</span>
      </a>
      <a href="patients.php" class="flex items-center space-x-3 hover:bg-white/10 p-2 rounded">
      ...
      <a href="settings.php" class="flex items-center space-x-3 hover:bg-white/10 p-2 rounded">
        <i class="ri-settings-3-line ri-lg"></i><span>Settings</span>
      </a>
  ...
  <div class="flex-1 flex flex-col">
    ...
    <main class="p-6 space-y-6">
      <div class="p-6">
  <h2 class="text-2xl font-semibold mb-6">Welcome back, Doctor!</h2>
