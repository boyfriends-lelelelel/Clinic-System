...
<head>
  ...
  <title>Evercare Medical Clinic - Management System</title>
    ...
    <div class="w-full md:w-1/2 bg-primary p-8 text-white flex flex-col justify-center relative">
      ...
      <div class="border-l-2 border-white pl-6 py-2 mt-20">
        <h1 class="text-2xl md:text-3xl font-bold mb-2">Welcome to 
          <span class="text-3xl md:text-4xl block mt-1">Evercare Medical Clinic</span>
        </h1>
    ...
    <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
      ...
      <form action="register.php" method="POST" id="loginForm">
        <div class="mb-4">
          ...
          <input type="email" name="email" id="email" class="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" placeholder="doctor@evercare.com" required>
        </div>
        ...
        <button type="submit" class="w-full bg-primary text-white py-3 rounded-button font-medium hover:bg-primary/90 transition-colors whitespace-nowrap" name="login">Sign In</button>
