...
<head>
  ...
  <title>Doctor's Dashboard - DermaHealth</title>
...
<body class="bg-gray-100 min-h-screen flex">
  <!-- Sidebar -->
  <aside class="w-64 bg-primary text-white min-h-screen p-6 space-y-6 hidden md:block">
    <div class="text-2xl font-pacifico mb-10">DermaHealth</div>
    <nav class="space-y-4">
      <a href="dashdoctor.php" class="flex items-center space-x-3 bg-white/20 p-2 rounded">
        <i class="ri-dashboard-line ri-lg"></i><span>Dashboard</span>
      </a>
      <a href="patientdoc.php" class="flex items-center space-x-3 hover:bg-white/10 p-2 rounded">
        <i class="ri-user-line ri-lg"></i><span>Patients</span>
      </a>
      <a href="appointments.php" class="flex items-center space-x-3 hover:bg-white/10 p-2 rounded">
        <i class="ri-calendar-line ri-lg"></i><span>Appointments</span>
      </a>
      <a href="recordsdoc.php" class="flex items-center space-x-3 hover:bg-white/10 p-2 rounded">
        <i class="ri-file-list-3-line ri-lg"></i><span>Records</span>
      </a>
      <a href="labresultdoc.php" class="flex items-center space-x-3 hover:bg-white/10 p-2 rounded">
        <i class="ri-user-line ri-lg"></i><span>Lab Results</span>
      </a>
      <a href="login.php" class="flex items-center space-x-3 hover:bg-white/10 p-2 rounded">
        <i class="ri-logout-box-r-line ri-lg"></i><span>Logout</span>
      </a>
    </nav>
  </aside>
  ...
  <div class="flex-1 flex flex-col">
    ...
    <header class="bg-white shadow p-4 flex justify-between items-center">
      <div class="text-xl font-semibold text-primary">Dashboard</div>
    ...
    <main class="p-6 space-y-6">
      <div class="p-6">
  <h2 class="text-2xl font-semibold mb-6">Welcome back, Doctor <?php 
