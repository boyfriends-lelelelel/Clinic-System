  ...
  <div class="flex min-h-screen">
    <aside class="w-64 bg-primary text-white p-6 space-y-6 hidden md:block">
      ...
      <nav class="space-y-4">
        ...
        <a href="recordsstaff.php" class="flex items-center space-x-3 bg-white/20 p-2 rounded"><i class="ri-file-list-3-line"></i><span>Medical Records</span></a>
        <a href="labresultsstaff.php" class="flex items-center space-x-3 hover:bg-white/10 p-2 rounded"><i class="ri-flask-line"></i><span>Lab Results</span></a>
