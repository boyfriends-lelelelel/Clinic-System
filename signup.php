    ...
    <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
      ...
      <form id="signupForm">
        ...
        <div class="mb-4">
          ...
          <input type="email" id="email" class="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" placeholder="you@example.com" required>
        </div>
        ...
        <button type="submit" class="w-full bg-primary text-white py-3 rounded-button font-medium hover:bg-primary/90 transition-colors whitespace-nowrap">Create Account</button>
        <div class="mt-6 text-center">
          <p class="text-gray-600">Already have an account? <a href="index.html" class="text-primary hover:underline">Sign In</a></p>
        </div>
      </form>
    </div>
  </div>
